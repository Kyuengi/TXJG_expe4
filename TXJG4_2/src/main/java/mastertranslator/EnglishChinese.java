 ...
 * 
 */
@WebServiceClient(name = "EnglishChinese", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/Y:/java/IDEA/rjsjms/untitled/TXJG4_2/src/main/resources/EnglishChinese.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Y:/java/IDEA/rjsjms/untitled/TXJG4_2/src/main/resources/EnglishChinese.wsdl");
    ...
    public EnglishChineseSoap getEnglishChineseSoap12() {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseSoap12"), EnglishChineseSoap.class);
    }
    ...
    public EnglishChineseSoap getEnglishChineseSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseSoap12"), EnglishChineseSoap.class, features);
    }
    ...
    public EnglishChineseHttpGet getEnglishChineseHttpGet() {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseHttpGet"), EnglishChineseHttpGet.class);
    }
    ...
    public EnglishChineseHttpGet getEnglishChineseHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseHttpGet"), EnglishChineseHttpGet.class, features);
    }
    ...
    public EnglishChineseHttpPost getEnglishChineseHttpPost() {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseHttpPost"), EnglishChineseHttpPost.class);
    }
    ...
    public EnglishChineseHttpPost getEnglishChineseHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebXml.com.cn/", "EnglishChineseHttpPost"), EnglishChineseHttpPost.class, features);
    }
