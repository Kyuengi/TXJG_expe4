...
public interface EnglishChineseSoap {
     ...
     * @param wordKey
     * @return
     *     returns mastertranslator.TranslatorResponse.TranslatorResult
     */
    ...
    @RequestWrapper(localName = "Translator", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.Translator")
    @ResponseWrapper(localName = "TranslatorResponse", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorResponse")
    public mastertranslator.TranslatorResponse.TranslatorResult translator(
    ...
    @RequestWrapper(localName = "TranslatorString", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorString")
    @ResponseWrapper(localName = "TranslatorStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorReferString", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorReferString")
    @ResponseWrapper(localName = "TranslatorReferStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorReferStringResponse")
    ...
    @RequestWrapper(localName = "TranslatorSentenceString", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorSentenceString")
    @ResponseWrapper(localName = "TranslatorSentenceStringResponse", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.TranslatorSentenceStringResponse")
    ...
    @RequestWrapper(localName = "SuggestWord", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.SuggestWord")
    @ResponseWrapper(localName = "SuggestWordResponse", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.SuggestWordResponse")
    ...
    @RequestWrapper(localName = "GetMp3", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.GetMp3")
    @ResponseWrapper(localName = "GetMp3Response", targetNamespace = "http://WebXml.com.cn/", className = "mastertranslator.GetMp3Response")
    public byte[] getMp3(
